...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (code.includes('email-already-in-use')) msg = 'An account with this email already exists.';
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-16" style={{ background: 'radial-gradient(ellipse at top, rgba(99,102,241,0.1), transparent 60%)' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--muted)' }}>Join Revenio and start exploring</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{ paddingLeft: '2.5rem', borderColor: errors.name ? 'var(--danger)' : 'var(--border)' }}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="input-field"
                  style={{ paddingLeft: '2.5rem', borderColor: errors.confirmPassword ? 'var(--danger)' : 'var(--border)' }}
                />
              </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--muted)' }}>
          ...
          <Link href="/login" className="font-semibold" style={{ color: 'var(--accent-light)' }}>
            Sign in
          </Link>
        </p>
      </div>
